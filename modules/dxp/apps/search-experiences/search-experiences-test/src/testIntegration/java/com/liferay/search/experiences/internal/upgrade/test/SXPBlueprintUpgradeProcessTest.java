	...
	public void testUpgradePortletPreferenceValue() throws Exception {
			...
			_addPortletPreferenceValue(
				...
				JSONUtil.put(
					JSONUtil.put(
						...
						"value", String.valueOf(sxpBlueprintId)
					)
				).toString());

		JSONObject suggestionsContributorSmallValueJSONObject = JSONUtil.put(
			"attributes",
			JSONUtil.put(
		...
		PortletPreferenceValue searchBarSuggestions =
			_addPortletPreferenceValue(
				...
				suggestionsContributorSmallValueJSONObject.toString(), null);
		...
		_assertPortletPreferenceValue(
			suggestionsContributorSmallValueJSONObject.put(
				"attributes",
				JSONUtil.put(
					"includeAssetSearchSummary", true
				).put(
